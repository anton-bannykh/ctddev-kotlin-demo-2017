...
class MainTest {
    ...
    fun test1() {
        ...
        val a: ArrayList<Int> = arrayListOf(1, 2, 3, 8, 10, 13, 15, 18, 22, 100)
    ...
    fun test2() {
        ...
        val a: ArrayList<Int> = arrayListOf(10, 20, 30, 80, 100, 103, 150, 180, 202, 300, 405, 409, 430, 502, 600)
    ...
    fun test3() {
        ...
        val a: ArrayList<Int> = arrayListOf(2, 4, 6, 8, 13, 14, 20, 22, 64, 100, 200, 300, 400, 500, 600, 700, 1000, 1200, 50000, 700000)
